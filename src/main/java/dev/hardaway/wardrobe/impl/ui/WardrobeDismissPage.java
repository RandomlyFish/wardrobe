...
public class WardrobeDismissPage extends InteractiveCustomUIPage<WardrobeDismissPage.PageEventData> {
    ...
    public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder commandBuilder, @Nonnull UIEventBuilder eventBuilder, @Nonnull Store<EntityStore> store) {
        commandBuilder.append("Wardrobe/Pages/Dismiss.ui");

        eventBuilder.addEventBinding(CustomUIEventBindingType.Activating, "#SaveChanges", EventData.of("Action", "Save"));
        eventBuilder.addEventBinding(CustomUIEventBindingType.Activating, "#DiscardChanges", EventData.of("Action", "Discard"));
    }
    ...
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store, @Nonnull PageEventData data) {
        ...
        if ("Discard".equals(data.action)) {
            if (wardrobe != null) store.putComponent(ref, PlayerWardrobe.getComponentType(), (PlayerWardrobeComponent) wardrobe);
